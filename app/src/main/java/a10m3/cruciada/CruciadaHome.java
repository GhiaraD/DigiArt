...
import a10m3.cruciada.Clase.Crucea;
...
public class CruciadaHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCruceaList.setHasFixedSize(true);
        mCruceaList.setLayoutManager(new LinearLayoutManager(this));
        mLayoutManager = new LinearLayoutManager(CruciadaHome.this);
    ...
    protected void onStart()
    {
        ...
        mCompKeyRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                final FirebaseRecyclerAdapter<Crucea,CruceaViewHolder> FBRA = new FirebaseRecyclerAdapter<Crucea, CruceaViewHolder>(
                        Crucea.class,
                        R.layout.crucea_row,
                    ...
                    protected void populateViewHolder(final CruceaViewHolder viewHolder, Crucea model, int position) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Users").child(mAuth.getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                if(type.compareTo("Concurent")==0)
                                {
                                    viewHolder.butonLike.setVisibility(View.GONE);
                                    viewHolder.butonLike2.setVisibility(View.GONE);
                                    viewHolder.butonLike3.setVisibility(View.GONE);
                                    viewHolder.butonLike4.setVisibility(View.GONE);
                                    viewHolder.butonLike5.setVisibility(View.GONE);
                                }
                            ...
                            public void onClick(View v) {
                                ...
                                databaseReference.child("CurrentStatus").addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        ...
                                        if(dataSnapshot.getValue().toString().trim().compareTo("Concurent")==0)
                                        {

                                            Toast.makeText(CruciadaHome.this,"Trebuie sa fii jurat pentru a vota",Toast.LENGTH_SHORT).show();
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        ...
        FirebaseDatabase.getInstance().getReference().child("Users").child(mAuth.getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                else if(type.compareTo("Jurat")==0)
                {
    ...
    {
        View mView;
        ImageView butonLike,butonLike2,butonLike3,butonLike4,butonLike5,post_image;
...
//        }
        ...
        {
            final Intent a = new Intent(CruciadaHome.this, a10m3.cruciada.MembersActivity.class);
            mCodConcursCurent.addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        else if(id == R.id.compDetalis){

            Intent intent4 = new Intent(CruciadaHome.this, a10m3.cruciada.DetailsActivity.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        finish();
        Intent no = new Intent(CruciadaHome.this, StartActivity.class);
